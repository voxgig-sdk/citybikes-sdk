...
Learn more about CityBikes API at [citybik.es](http://citybik.es).
...
| Go CLI | `github.com/voxgig-sdk/citybikes-sdk/go-cli` | `go install github.com/voxgig-sdk/citybikes-sdk/go-cli/cmd/citybikes@latest` |
| Go MCP server | `github.com/voxgig-sdk/citybikes-sdk/go-mcp` | `go get github.com/voxgig-sdk/citybikes-sdk/go-mcp@latest` |
...
$networks = $client->Network()->list();
print_r(array_map(fn($item) => $item->data_get(), $networks));
