...
from citybikes_sdk.utility import register

# Load features
from citybikes_sdk.feature.base_feature import CitybikesBaseFeature
from citybikes_sdk.features import _has_feature, _make_feature
...
class CitybikesSDK:
    ...
    def get_utility(self):
        return CitybikesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CitybikesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Network(self, data=None) -> "NetworkEntity":
        ...
        from citybikes_sdk.entity.network_entity import NetworkEntity
        return NetworkEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "CitybikesSDK":
        if sdkopts is None:
            sdkopts = {}
