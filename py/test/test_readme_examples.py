# Citybikes SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CitybikesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CitybikesSDK(...) and CitybikesSDK.test(...) become
#      CitybikesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "citybikes_sdk"
_SDK_CLASS = "CitybikesSDK"
