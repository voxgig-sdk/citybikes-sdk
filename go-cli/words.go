...
func registerSDKWords(r *eng.Registry, client *sdk.CitybikesSDK) {
...
func runOp(client *sdk.CitybikesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
