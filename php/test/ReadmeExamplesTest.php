...
// Citybikes SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CitybikesSDK::test)
...
{
    private const SDK_CLASS = 'CitybikesSDK';
    ...
    private const SDK_BASE = 'citybikes_sdk';
