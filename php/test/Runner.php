...
class CitybikesTestRunner
{
    ...
    {
        $live = self::getenv('CITYBIKES_TEST_LIVE');
        $override = self::getenv('CITYBIKES_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CITYBIKES_TEST_EXPLAIN');
...
class_alias('CitybikesTestRunner', 'Runner');
class_alias('CitybikesHelpers', 'Helpers');
