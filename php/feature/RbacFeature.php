...
class CitybikesRbacFeature extends CitybikesBaseFeature
{
    ...
    private function _required(CitybikesContext $ctx): ?string
    {
    ...
    private function _reject(CitybikesContext $ctx, string $required): void
    {
    ...
    private function _track(CitybikesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
