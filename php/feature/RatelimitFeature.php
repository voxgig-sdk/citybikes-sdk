...
// Citybikes SDK ratelimit feature
...
class CitybikesRatelimitFeature extends CitybikesBaseFeature
{
    ...
    private function _acquire(CitybikesContext $ctx): void
    {
    ...
    private function _track(CitybikesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
