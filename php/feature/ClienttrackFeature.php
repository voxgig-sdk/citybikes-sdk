...
// Citybikes SDK clienttrack feature
...
class CitybikesClienttrackFeature extends CitybikesBaseFeature
{
    ...
    public function PostConstruct(CitybikesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Citybikes-SDK';
