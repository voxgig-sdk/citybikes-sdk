...
class CitybikesProxyFeature extends CitybikesBaseFeature
{
    ...
    public function init(CitybikesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CitybikesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
