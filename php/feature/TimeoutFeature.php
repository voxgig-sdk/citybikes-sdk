...
class CitybikesTimeoutFeature extends CitybikesBaseFeature
{
    ...
    private function _with_timeout(CitybikesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CitybikesContext $_ctx, float $ms): void
    {
        $client = $this->client;
