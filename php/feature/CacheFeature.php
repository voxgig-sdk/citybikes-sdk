...
class CitybikesCacheFeature extends CitybikesBaseFeature
{
    ...
    private function _through(CitybikesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
