# Citybikes Golang SDK Reference

Complete API reference for the Citybikes Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *CitybikesSDK`
...
#### `Network(data map[string]any) CitybikesEntity`
