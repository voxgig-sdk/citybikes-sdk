...
func registerTools(server *mcp.Server, client *sdk.CitybikesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "citybikes_list",
		Description: "List records from Citybikes. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "citybikes_load",
		Description: "Load a single record from Citybikes. " +
...
func runOp(client *sdk.CitybikesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CitybikesSDK, name string) (sdk.CitybikesEntity, error) {
