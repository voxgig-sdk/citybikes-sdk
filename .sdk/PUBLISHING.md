...
|---|---|---|
| `ts/` | @voxgig-sdk/citybikes-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/citybikes-sdk \
      --repository voxgig-sdk/citybikes-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/citybikes-sdk` shows it, and
`npm trust revoke @voxgig-sdk/citybikes-sdk --id=<id>` removes it.
