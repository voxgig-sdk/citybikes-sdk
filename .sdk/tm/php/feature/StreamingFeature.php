...
// Citybikes SDK streaming feature
...
class CitybikesStreamingFeature extends CitybikesBaseFeature
{
    ...
    private function _iterate(CitybikesResult $result): \Generator
    {
    ...
    private function _streamable(CitybikesContext $ctx): bool
    {
