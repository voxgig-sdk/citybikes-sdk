...
// Citybikes SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CitybikesTestFeature extends CitybikesBaseFeature
{
    ...
    public function init(CitybikesContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CitybikesContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = CitybikesParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CitybikesContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CitybikesContext $ctx, $op, $args): array
    {
