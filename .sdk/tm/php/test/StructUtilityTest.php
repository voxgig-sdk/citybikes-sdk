...
// Citybikes SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CitybikesOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CitybikesOmni::structfix($now, Struct::undef()))
                        !== json_encode(CitybikesOmni::structfix($val, Struct::undef()))) {
