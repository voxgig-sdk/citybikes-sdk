...
class CitybikesGraphql
{
    ...
    // equivalent.
    public static function body(CitybikesContext $ctx): mixed
    {
    ...
    public static function errors(CitybikesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
