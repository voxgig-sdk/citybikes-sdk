...
// Citybikes SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CitybikesMakeRequest
{
    public static function call(CitybikesContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CitybikesResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CitybikesResponse($fetched);
        } else {
