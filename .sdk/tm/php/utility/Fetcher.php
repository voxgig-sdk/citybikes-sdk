...
// Citybikes SDK utility: fetcher

class CitybikesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CitybikesSDK/1.0)';
    ...
    public static function call(CitybikesContext $ctx, string $fullurl, array $fetchdef): array
    {
