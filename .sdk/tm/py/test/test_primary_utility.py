...
from projectname_sdk import CitybikesSDK
from projectname_sdk.core.spec import CitybikesSpec
from projectname_sdk.core.result import CitybikesResult
from projectname_sdk.core.response import CitybikesResponse
from projectname_sdk.core.operation import CitybikesOperation
from projectname_sdk.core.error import CitybikesError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import CitybikesBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return CitybikesError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = CitybikesSDK.test(None, None)
        ...
        class TestInitFeature(CitybikesBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(CitybikesBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = CitybikesSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = CitybikesSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = CitybikesSDK.test(None, setup_opts)
