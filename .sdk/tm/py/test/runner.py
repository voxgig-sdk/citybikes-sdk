...
class CitybikesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CitybikesTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = CitybikesTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = CitybikesTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
