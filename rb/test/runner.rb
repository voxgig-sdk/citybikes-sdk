...
module CitybikesTestRunner
  ...
  def self.env_override(m)
    live = getenv("CITYBIKES_TEST_LIVE")
    override = getenv("CITYBIKES_TEST_OVERRIDE")
    ...
    explain = getenv("CITYBIKES_TEST_EXPLAIN")
    m["CITYBIKES_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = CitybikesTestRunner
Helpers = CitybikesHelpers
Vs = VoxgigStruct
