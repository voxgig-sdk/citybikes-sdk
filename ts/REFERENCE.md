# Citybikes TypeScript SDK Reference

Complete API reference for the Citybikes TypeScript SDK.
...
```ts
new CitybikesSDK(options?: object)
```
...
#### `CitybikesSDK.test(testopts?, sdkopts?)`
...
**Returns:** `CitybikesSDK` instance in test mode.
...
Return the parent `CitybikesSDK` instance.
