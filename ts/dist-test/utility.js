...
function envOverride(m) {
    if ('TRUE' === process.env.CITYBIKES_TEST_LIVE ||
        'TRUE' === process.env.CITYBIKES_TEST_OVERRIDE) {
    ...
    m.CITYBIKES_TEST_EXPLAIN = process.env.CITYBIKES_TEST_EXPLAIN || m.CITYBIKES_TEST_EXPLAIN;
    return m;
}
