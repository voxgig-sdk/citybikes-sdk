...
describe('exists', async () => {
  ...
  //
  // CitybikesSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof CitybikesSDK, true,
      'CitybikesSDK.test() must return a client synchronously')
  })
