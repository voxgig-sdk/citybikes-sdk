...
describe("NetworkDirect", function()
  it("should direct-list-network", function()
    local setup = network_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-network", setup.live and "live" or "unit")
